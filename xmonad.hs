...
--
--startupHook = spawn «feh --bg-scale ~/001.jpg»
...
--
myNormalBorderColor  = "#072E33"
myFocusedBorderColor = "#0C7076"
...
-- main :: IO()
main = do
  xmproc <- spawnPipe "xmobar -x 0 /home/c3k/.config/xmobar/xmobarrc"
--xmproc <- spawnPipe "/home/c3k/.config/xmobar/xmobarrc"
